...
module.exports = function (options) {
    ...
    reg = new RegExp('["\'\\(](\\$\\{tzp\\.getContextPath\\(\\)\\})?\\s*([\\w\\_\/\\.\\-]*\\.(' + (options.exts ? options.exts.join('|') : 'jpg|jpeg|png|gif|cur|js|css') + '))([^\\)"\']*)\\s*[\\)"\']', 'gim');
	...
	return through.obj(function (file, enc, callback) {
		...
		contents = file.contents.toString().replace(reg, function (content,javaObj, filePath, ext, other) {
			var fullPath;
